...
//		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//b[text()='View more availability']"))).click();
		...
		driver.findElement(By.xpath("//*[text()=' Next available appointment is on Feb 20, 2025']")).click();
		driver.findElement(By.xpath("(//div[@class=\"flex flex-col slotgroup\"])[1]")).click();
		

		Thread.sleep(2000);

		driver.findElement(By.xpath("//*[@name='patient_first_name']")).sendKeys("Samantha");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//label[contains(.,'No')]"))).click();
		...
		WebElement ethnicity= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span//span[text()='Please select an option below'])[1]")));
		ethnicity.click();
		...
		actions1.moveToElement(ethnicity).keyDown(Keys.ARROW_DOWN).keyDown(Keys.ENTER).perform();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(.,'Self')][1]"))).click();
...
//		pharmacy.click();
		...
		WebElement mc=
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class='select2-selection__arrow']")));
	...
	a.moveToElement(all).keyDown(Keys.ARROW_DOWN).keyDown(Keys.ENTER).perform();
	...
	WebElement med=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("select2-medication-o9-container")));
	...
	WebElement s=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[@class='select2-selection select2-selection--single'])[2]")));	
	
	s.click();
	
	Actions at=new Actions(driver);
	
	at.moveToElement(s).keyDown(Keys.ARROW_DOWN).keyDown(Keys.ENTER).perform();
	
	Thread.sleep(3000);
	
	WebElement add=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='+ Add']")));
	
	add.click();
	
	Thread.sleep(3000);
	
	driver.findElement(By.xpath("//span[@class='common-btn px-5 d-inline-flex common-action-btn']")).click();
